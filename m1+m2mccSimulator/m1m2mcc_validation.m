...
for i = 1 : length(sim_lambda2)
    ...
    ana_CBP(i) = y;
    ana_HFP(i) = (1 / factorial(c)) * (((sim_lambda1 + sim_lambda2) / u) ^ (c - n)) * ((sim_lambda1 / u) ^ n) * P0(i);
end
